...
from speechcorpus.utils import read_csv
...
class Metadata:
    ...
    def get_metadata(self):
        ...
        csvreader = read_csv(self.metadata_filename)
...
class Transcript:
    ...
    def __init__(self, swda_filename, metadata):
        ...
        # rows = csv.reader(self.swda_filename).read()
        rows = read_csv(self.swda_filename)
        ...
        self.utterances = filter(
            (lambda x: not re.search(r"[@]", x.act_tag)), self.utterances
        )
